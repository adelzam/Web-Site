...
/**
 * Created by adelzamalutdinov on 12.04.16.
 */
@Controller
@RequestMapping("/reg")
public class RegistrationController {
    ...
    public String renderRegistrationPage() {
        ...
        return "user/registration/registrationPage";
    }
    ...
    public String registrationForm(
        ...
        userService.add(new UserInfo(registrationFormBean.getFirstName().concat(" ").concat(registrationFormBean.getLastName()),
                registrationFormBean.getEmail(), DigestUtils.md5DigestAsHex(registrationFormBean.getPassword().getBytes()),
                "ROLE_USER",
                null,
                false, null));
